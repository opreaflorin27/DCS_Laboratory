...
public class OutsideTermoMain {
    ...
    public static void main(String[] args) {
        ...
        OutsideReferenceCalculator outTermo = new OutsideReferenceCalculator(plant, tankController, SIM_PERIOD);
        termostat.start();
...
// double waterRefTemp = 62.0;
        ...
        for (int i = 0; i < sceonario.getScenarioLength(); i++) { outTermo.setOutsideTemp(sceonario.getOutSideTemepratue(i));
