...
public class InputInt extends JFrame {
		...
		btnSend.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					DataToSend.petriObject = new DataInteger();
					if (!txtValue.getText().equals("null")) {
						DataToSend.petriObject.SetValue(Integer.parseInt(txtValue.getText()));
					} else {
